...
2. Muevase a la carpeta creada con el comando `cd nombre-de-la-carpeta`
3. Ejecute el comando `npm install` para instalar dependecias y crear la carpeta `node_modules`.
...
-Confirmación antes de eliminar artículos.
